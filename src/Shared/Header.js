...
const Header = () => {
    const menu = <>
        ...
        <li>
            <a className="gap-x-2 btn-ghost" href='https://drive.google.com/file/d/1ycG_yfYC8X_L0hDqmq5_XGRn9CMS9Lhj/view?usp=sharing' target="_blank">Resume</a>
        </li>
    </>
    ...
    return (
        <div className="navbar bg-gradient-to-r from-cyan-500 to-blue-500  text-white fixed top-0 z-10 px-16">
