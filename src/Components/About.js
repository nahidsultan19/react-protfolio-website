...
const About = () => {
    return (
        <div className='lg:flex justify-center items-center h-screen sm:px-10 text-white' id='about'>
            <div className=''>
                <img src={profile} alt="" className='mask mask-circle p-10 lg:max-w-sm md:w-96 mx-auto bg-indigo-200' data-aos="fade-down" data-aos-offset="200" data-aos-duration="1000" />
            </div>
            <div className='lg:py-12 ml-10 pb-5 max-w-md md:mx-auto sm:pe-4' data-aos="fade-left" data-aos-offset="200" data-aos-duration="2000">
